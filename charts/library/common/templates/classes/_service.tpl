...
*/}}
{{- define "geek-cookbook.common.classes.service" -}}
...
{{- $primaryPort := get $values.ports (include "geek-cookbook.common.classes.service.ports.primary" (dict "values" $values)) }}
---
apiVersion: v1
kind: Service
metadata:
...
spec:
  ...
  {{- end }}
  selector:
    {{- include "geek-cookbook.common.labels.selectorLabels" . | nindent 4 }}
{{- end }}
