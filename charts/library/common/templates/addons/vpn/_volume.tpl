...
*/}}
{{- define "geek-cookbook.common.addon.vpn.scriptsVolumeSpec" -}}
...
*/}}
{{- define "geek-cookbook.common.addon.vpn.configVolumeSpec" -}}
...
secret:
  ...
  {{- else }}
  secretName: {{ include "geek-cookbook.common.names.fullname" . }}-vpnconfig
  {{- end }}
  items:
    - key: vpnConfigfile
      path: vpnConfigfile
